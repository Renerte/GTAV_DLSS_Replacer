...
namespace GTAV_DLSS_Replacer
{
    ...
    internal static class Program
    {
        ...
        private const string GtaVLocationFileForAutoStart = "GtaV_location_for_auto_start.txt"; //to auto launch GTAV as told from this location
